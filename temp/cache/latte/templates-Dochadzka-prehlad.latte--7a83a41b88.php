<?php
// source: E:\xampp\htdocs\sandbox\app\presenters/templates/Dochadzka/prehlad.latte

use Latte\Runtime as LR;

class Template7a83a41b88 extends Latte\Runtime\Template
{
	public $blocks = [
		'banner' => 'blockBanner',
		'title' => 'blockTitle',
...
<?php
							if ($post2['odchod']) {
								?>                        <?php echo LR\Filters::escapeHtmlText(call_user_func($this->filters->date, $post2['odchod'], "d. m. Y G:i:s")) /* line 88 */ ?>

<?php
								if ($vypisovat_realne_casy) {
?>
                            <br>
                            ( <?php echo LR\Filters::escapeHtmlText(call_user_func($this->filters->date, $posts_raw_dochadzka[$osoba][$index]['odchod'], "G:i:s")) /* line 91 */ ?> )
<?php
								}
							}
							else {
...
?>
                ...
                <td>
                    <?php echo LR\Filters::escapeHtmlText(call_user_func($this->filters->date, $post2['cas_v_praci'], "%h:%I")) /* line 98 */ ?>
