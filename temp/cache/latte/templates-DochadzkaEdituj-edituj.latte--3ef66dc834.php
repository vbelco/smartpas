<?php
// source: C:\xampp\htdocs\sandbox\app\presenters/templates/DochadzkaEdituj/edituj.latte

use Latte\Runtime as LR;

class Template3ef66dc834 extends Latte\Runtime\Template
{
	public $blocks = [
		'banner' => 'blockBanner',
		'title' => 'blockTitle',
...
<div>
    <ul class="nav nav-pills">
        ...
        <li class="active"><a href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Dochadzka:Edituj:edituj")) ?>"><?php
