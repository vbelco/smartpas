<?php
// source: C:\xampp\htdocs\sandbox\app\presenters/templates/Osoby/edituj.latte

use Latte\Runtime as LR;

class Templateefc89602a2 extends Latte\Runtime\Template
{
	public $blocks = [
		'banner' => 'blockBanner',
		'title' => 'blockTitle',
...
<?php
	...
	{
		extract($_args);
		?>    <h1><?php echo LR\Filters::escapeHtmlText(call_user_func($this->filters->translate, "ui.editacia_osoby")) ?></h1>
<?php
	}
...
<div>
<a href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Osoby:deaktivuj", [$osoba_id])) ?>"><button type="button" class="btn btn-danger"><?php
			echo LR\Filters::escapeHtmlText(call_user_func($this->filters->translate, "ui.deactivate_person")) ?></button></a>
</div>
