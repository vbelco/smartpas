...
?>
            <tr>
                ...
                <td> <?php echo LR\Filters::escapeHtmlText(call_user_func($this->filters->date, $post->prichod_timestamp, "d. m. Y G:i:s")) /* line 22 */ ?> </td>
                <td> <?php echo LR\Filters::escapeHtmlText(call_user_func($this->filters->date, $post->odchod_timestamp, "d. m. Y G:i:s")) /* line 23 */ ?> </td>
            </tr>
