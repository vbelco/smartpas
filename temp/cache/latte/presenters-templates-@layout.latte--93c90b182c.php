...
<?php
		if ($user->loggedIn) {
			?>                        SmartPAS <?php echo LR\Filters::escapeHtmlText($nazov_planu) /* line 37 */ ?>
...
?>
			...
			echo LR\Filters::escapeHtmlText($meno_uzivatela) /* line 53 */ ?></a></li> 
                <li style="margin-top: 8px;">
                    <div class="dropdown">
                        <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                        <span class="lang-xs lang-lbl" lang="<?php echo LR\Filters::escapeHtmlAttr($activeLocale) /* line 57 */ ?>"></span>
                        </button>
                ...
                <li style="margin-top: 8px;">
                    <div class="btn-group dropdown">
                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                            <span class="lang-xs lang-lbl" lang="<?php echo LR\Filters::escapeHtmlAttr($activeLocale) /* line 76 */ ?>"></span>
                        </button>
