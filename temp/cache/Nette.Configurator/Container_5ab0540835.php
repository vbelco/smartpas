<?php
// source: E:\xampp\htdocs\sandbox\app/config/config.local.neon 

class Container_5ab0540835 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'Nette\Object' => [
				1 => [
					...
					'64_App_Model_Osoba',
					'65_App_Model_PracovnaDoba',
					'66_App_Model_RFID',
					'67_App_Model_Uzivatel',
					'authenticator',
					'application.5',
				],
			...
			'App\Model\PracovnaDoba' => [1 => ['65_App_Model_PracovnaDoba']],
			'App\Model\RFID' => [1 => ['66_App_Model_RFID']],
			'App\Model\Uzivatel' => [1 => ['67_App_Model_Uzivatel']],
			...
			'App\Presenters\EditujDochadzkaPresenter' => [1 => ['application.3']],
			...
			'App\Presenters\OsobyPresenter' => [1 => ['application.7']],
			'App\Presenters\RFIDPresenter' => [1 => ['application.8']],
			'App\Presenters\SignPresenter' => [1 => ['application.9']],
			'App\Presenters\UserPresenter' => [1 => ['application.10']],
		...
		'services' => [
			...
			'65_App_Model_PracovnaDoba' => 'App\Model\PracovnaDoba',
			'66_App_Model_RFID' => 'App\Model\RFID',
			'67_App_Model_Uzivatel' => 'App\Model\Uzivatel',
			...
			'application.3' => 'App\Presenters\EditujDochadzkaPresenter',
			...
			'application.7' => 'App\Presenters\OsobyPresenter',
			'application.8' => 'App\Presenters\RFIDPresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'E:\xampp\htdocs\sandbox\app',
			'wwwDir' => 'E:\xampp\htdocs\sandbox\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'E:\xampp\htdocs\sandbox\app/../temp',
		];
	}
	...
	public function createService__65_App_Model_PracovnaDoba(): App\Model\PracovnaDoba
	{
		$service = new App\Model\PracovnaDoba($this->getService('database.default.context'));
		return $service;
	}


	public function createService__66_App_Model_RFID(): App\Model\RFID
	{
	...
	public function createService__67_App_Model_Uzivatel(): App\Model\Uzivatel
	{
	...
	public function createServiceApplication__1(): App\Presenters\CitackaPresenter
	{
		$service = new App\Presenters\CitackaPresenter($this->getService('database.default.context'),
			$this->getService('67_App_Model_Uzivatel'), $this->getService('61_App_Model_Citacka'));
	...
	public function createServiceApplication__10(): App\Presenters\UserPresenter
	{
		$service = new App\Presenters\UserPresenter($this->getService('database.default.context'),
			$this->getService('67_App_Model_Uzivatel'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	public function createServiceApplication__2(): App\Presenters\DochadzkaPresenter
	{
		$service = new App\Presenters\DochadzkaPresenter($this->getService('database.default.context'),
			$this->getService('67_App_Model_Uzivatel'), $this->getService('62_App_Model_Dochadzka'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	public function createServiceApplication__3(): App\Presenters\EditujDochadzkaPresenter
	{
		$service = new App\Presenters\EditujDochadzkaPresenter($this->getService('database.default.context'),
			$this->getService('67_App_Model_Uzivatel'), $this->getService('62_App_Model_Dochadzka'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
	...
	public function createServiceApplication__7(): App\Presenters\OsobyPresenter
	{
		$service = new App\Presenters\OsobyPresenter($this->getService('database.default.context'),
			$this->getService('67_App_Model_Uzivatel'), $this->getService('64_App_Model_Osoba'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	public function createServiceApplication__8(): App\Presenters\RFIDPresenter
	{
		$service = new App\Presenters\RFIDPresenter($this->getService('database.default.context'),
			$this->getService('67_App_Model_Uzivatel'), $this->getService('66_App_Model_RFID'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'E:\xampp\htdocs\sandbox\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('E:\xampp\htdocs\sandbox\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('E:\xampp\htdocs\sandbox\app/../temp/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_5ab0540835 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('E:\xampp\htdocs\sandbox\app/../temp/cache/latte');
	...
	{
		$service = new Kdyby\Translation\CatalogueCompiler(new Kdyby\Translation\Caching\PhpFileStorage('E:\xampp\htdocs\sandbox\app/../temp/cache',
	...
	public function createServiceTranslation__default(): Kdyby\Translation\Translator
	{
		...
		$service->addResource('neon', 'E:\xampp\htdocs\sandbox\app\lang\menu.en_US.neon',
			'en_US', 'menu');
		$service->addResource('neon', 'E:\xampp\htdocs\sandbox\app\lang\menu.sk_SK.neon',
			'sk_SK', 'menu');
		$service->addResource('neon', 'E:\xampp\htdocs\sandbox\app\lang\reader.en_US.neon',
			'en_US', 'reader');
		$service->addResource('neon', 'E:\xampp\htdocs\sandbox\app\lang\reader.sk_SK.neon',
			'sk_SK', 'reader');
		$service->addResource('neon', 'E:\xampp\htdocs\sandbox\app\lang\ui.en_US.neon',
			'en_US', 'ui');
		$service->addResource('neon', 'E:\xampp\htdocs\sandbox\app\lang\ui.sk_SK.neon',
			'sk_SK', 'ui');
		return $service;
	}
	...
	{
		$service = new Kdyby\Translation\Diagnostics\Panel('E:\xampp\htdocs\sandbox');
		$service->setLocaleWhitelist(['sk', 'en']);
