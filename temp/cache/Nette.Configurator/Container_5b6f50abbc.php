<?php
// source: E:\xampp\htdocs\sandbox\app/config/config.neon 

class Container_5b6f50abbc extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_5b6f50abbc $container)
			{
